...
// ============================================================================
// PaymentDialogContent — contenu sans wrapper <Dialog>
// Même logique que PaymentDialog, à utiliser dans un DialogContent existant.
// ============================================================================
				...
				{paymentEntries.length > 0 && (
					<div className='space-y-1.5'>
						...
						<div className='flex items-center justify-between rounded-md bg-muted/50 px-3 py-1.5 text-sm'>
							...
							<span
								className={`font-semibold tabular-nums ${
									remaining > 0.005 ? 'text-destructive' : 'text-emerald-600'
								}`}
							>
								{Math.abs(remaining).toFixed(2)} €
							</span>
