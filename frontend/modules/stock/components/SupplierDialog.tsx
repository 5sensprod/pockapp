...
export function SupplierDialog({ open, onOpenChange, supplier = null }: SupplierDialogProps) {
  ...
  const toggleBrand = (brandId: string) => {
    ...
    if (current.includes(brandId)) {
      form.setValue('brands', current.filter((id) => id !== brandId))
    } else {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            {isEdit ? 'Modifiez les informations' : 'Ajoutez un nouveau fournisseur'}
          </DialogDescription>
        </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="email" placeholder="contact@metro.fr" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="123 rue du Commerce, 75001 Paris" rows={2} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Notes internes..." rows={2} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem className="flex items-center justify-between rounded-lg border p-3">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Fournisseur actif</p>
                  </div>
                  <FormControl>
