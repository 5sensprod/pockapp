...
func startPocketBaseNoCobra(pb *pocketbase.PocketBase, embeddedAssets embed.FS) {
	...
	pb.OnBeforeServe().Add(func(e *core.ServeEvent) error {
		...
		routes.RegisterJournalRoutes(pb, e.Router)
		routes.RegisterJournalEspecesRoutes(pb, e.Router)
		...
		routes.RegisterLabelPrintRoutes(pb, e.Router)
		...
		routes.RegisterSiteImagesRoutes(pb, e.Router)
